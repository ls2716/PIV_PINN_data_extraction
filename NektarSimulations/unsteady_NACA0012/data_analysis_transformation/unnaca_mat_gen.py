...
uu_tmp = plt_data[:,5].reshape(1501,601).T
uv_tmp = plt_data[:,6].reshape(1501,601).T
vv_tmp = plt_data[:,7].reshape(1501,601).T
...
# plt.title('unsteady NACA0012 alpha field truth')
...
# axes.set_aspect(1)
# plt.tight_layout()
# plt.savefig('unsteadyNACA0012/truth_alpha.png')
# plt.close()
# plt.figure(figsize=(10,5))
# plt.title('unsteady NACA0012 beta field truth')
...
# axes.set_aspect(1)
# plt.tight_layout()
# plt.savefig('unsteadyNACA0012/truth_beta.png')
# plt.close()
...
plt.figure(figsize=figsize)
plt.title('unsteady NACA0012 uu field truth')
...
axes.set_aspect(1)
plt.tight_layout()
plt.savefig('unsteadyNACA0012/truth_uu.png')
plt.close()

plt.figure(figsize=figsize)
plt.title('unsteady NACA0012 uv field truth')
plt.pcolor(X, Y, uv_tmp)
...
axes.set_aspect(1)
plt.tight_layout()
plt.savefig('unsteadyNACA0012/truth_uv.png')
plt.close()

plt.figure(figsize=figsize)
plt.title('unsteady NACA0012 vv field truth')
...
axes.set_aspect(1)
plt.tight_layout()
plt.savefig('unsteadyNACA0012/truth_vv.png')
plt.close()
...
from equations import RANSf02D,RANSf0var2D, func_zeros
...
def main(train=True, test=True):
    # case name
    case_name = "unNACA0012_f_as_var_with_pressure"
    case_name_title = r'PIV stride $0.01 \times 0.01$ curlf as var'
    ...
    if train:
        ...
        plot_train_points(data, [2,4,5,7], ["airfoil velocities", "forcing", "pressure", "piv"],

...
def main(train=True, test=True):
    # case name
    case_name = "unCylinder_2nd_order_superresolutions"
    ...
    if train:
        data = dde.data.PDE(
            geom,
            pde,
            [bc_wall_u, bc_wall_v, bc_wall_uu, bc_wall_uv, bc_wall_vv, u_piv_points, uu_piv_points, v_piv_points, vv_piv_points, uv_piv_points],
            100,
            1600,
            solution=None,
            num_test=100,
        ...
        plot_train_points(data, [2,5,10], ["u,v wall BC", "uu,uv,vv wall BC", "PIV data"],

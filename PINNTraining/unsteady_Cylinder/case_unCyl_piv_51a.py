...
def main(train=True, test=True):
    # case name
    case_name = "unCylinder_2nd_order_superresolutions_with_pressure_anchor_0.02"
    case_name_title = r'PIV superresolution second order 0.02 by 0.02'

...
def main(train=True, test=True):
    # case name
    case_name = "unCylinder_2nd_order_superresolutions_with_pressure_anchor_1.0"
    case_name_title = r'PIV superresolution second order 1.0 by 1.0'

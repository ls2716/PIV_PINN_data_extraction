...
def main(train=True, test=True):
    # case name
    case_name = "unCylinder_piv_superresolution_0.02_no_pressure"
    case_name_title = r'PIV stride $0.02 \times 0.02$ f=0'
    ...
    if test:
        ...
        model.restore(f"{case_name}/models/model_unCylinder_piv_superresolution_0.02_no_pressure.ckpt-1")

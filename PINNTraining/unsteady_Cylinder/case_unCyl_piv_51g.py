...
def main(train=True, test=True):
    # case name
    case_name = "unCylinder_2nd_order_superresolutions_with_pressure_anchor_0.7"
    case_name_title = r'PIV superresolution second order 0.7 by 0.7'
